 ...
 *
 * file directly from https://github.com/pmmp/PocketMine-MP/blob/dca5a9d8ea13117d9eef350500e28ec77187b4a3/src/utils/Filesystem.php
...
final class Filesystem{
    ...
    public static function recursiveUnlink(string $dir) : void{
        if(is_dir($dir)){
            ...
            if($objects === false) throw new \AssertionError("scandir() shouldn't return false when is_dir() returns true");
    ...
    private static function recursiveCopyInternal(string $origin, string $destination) : void{
        if(is_dir($origin)){
            ...
            if(!is_dir($dirName)){ //the destination folder should already exist
                throw new \AssertionError("The destination folder should have been created in the parent call");
            }
