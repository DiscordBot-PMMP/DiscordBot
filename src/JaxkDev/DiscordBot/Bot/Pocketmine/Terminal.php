 ...
 *
 * file directly from https://github.com/pmmp/PocketMine-MP/blob/dca5a9d8ea13117d9eef350500e28ec77187b4a3/src/utils/Terminal.php
 *
*/
...
abstract class Terminal{
    ...
    private static function detectFormattingCodesSupport() : bool{
        ...
        if($stdout === false) throw new \AssertionError("Opening php://stdout should never fail");
        $result = (
